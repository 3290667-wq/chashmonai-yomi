      ...
      {activeTab === "overview" && (
        ...
        >
          ...
          >
            ...
            {/* Detailed Points Explanation */}
            <div className="p-4 sm:p-5 border-t border-sky-200 bg-sky-50/50">
              <p className="text-xs text-slate-500 leading-relaxed">
                <span className="font-semibold text-slate-600">פירוט מלא על מערכת הנקודות:</span>
                {" "}נקודות נצברות באופן אוטומטי בזמן לימוד באפליקציה. על כל 5 דקות לימוד פעיל (משנה, רמב״ם, חסידות, מוסר או צפייה בסרטון) תקבל נקודה אחת.
                {" "}בנוסף, על כל יום רצוף של לימוד (רצף יומי) תקבל בונוס של 5 נקודות נוספות.
                {" "}השלמת לימוד יומי מלא מזכה ב-10 נקודות בונוס.
                {" "}את הנקודות ניתן לממש בשק״ם (שירותי קנטינה משולבים) - פשוט הזן את כמות הנקודות שברצונך לסלוק, הבקשה תועבר לאישור המפקד, ולאחר האישור תוכל לממש את הנקודות.
                {" "}שים לב: נקודות שנמצאות בהמתנה לאישור לא זמינות לסליקה נוספת עד לאישור או דחיית הבקשה.
              </p>
            </div>
          </motion.div>
        </motion.div>
